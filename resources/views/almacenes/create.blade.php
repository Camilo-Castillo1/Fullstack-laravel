...
@section('header', 'Crear Almacén')

@section('content')
<div class="container py-4">
    <div class="card shadow border-0" id="almacenCard">
        <div class="card-body">
            <h5 class="mb-4">Nuevo Almacén</h5>
            ...
            <form method="POST" action="{{ route('admin.almacenes.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="ubicacion" name="ubicacion" rows="3" required>{{ old('ubicacion') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="capacidad_maxima" name="capacidad_maxima" value="{{ old('capacidad_maxima') }}" min="1" required>
                    @error('capacidad_maxima') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                </div>

                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.almacenes.index') }}" class="btn btn-secondary me-2">Cancelar</a>
